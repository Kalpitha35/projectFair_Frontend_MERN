...
import Upload_img from '../assets/Upload-Image.png'
...
const Edit = ({project}) => {
  ...
  //props value cannot be changed, state value can be changed. so we create state and props will added to the state.
        ...
        <div className="row align-items-center">
            <div className="col-lg-4">
              <label>
                ...
                <img height={'180px'} width={'180px'} className='img-fluid' src={preview?preview:`${SERVER_URL}/uploads/${project.projectImg}`} alt="" />
              </label>
             { 
              !imageFileStatus &&
