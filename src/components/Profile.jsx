      ...
      <Collapse in={open}>
        <div  className="row container-fluid align-items-center justify-content-center shadow p-2 rounded" id="example-collapse-text">
          <label className='text-center'>
           ...
           {
            existingProfileImg=="" ?
            <img  height={'200px'} width={'200px'} className='rounded-circle' src={preview?preview:profileImg} alt="" />
            :
            <img  height={'200px'} width={'200px'} className='rounded-circle' src={preview?preview:`${SERVER_URL}/uploads/${existingProfileImg}`} alt="" />
           }
          </label>
